...
switch (menu_level) {
	...
	switch (pos){
			...
			case 0: if option[10,0]= "Saved Game 1"{global.can_save=false;load_game(1)};
			break;									
													
			case 1: if option[10,1]= "Saved Game 2"{global.can_save=true;load_game(2)};
			break;									
													
			case 2: if option[10,2]= "Saved Game 3"{global.can_save1=true;load_game(3)};
			break;
...
if !file_exists("savedata1.sav"){option[10,0]= "No saved game"};
				
if !file_exists("savedata2.sav"){option[10,1]= "No saved game"};	
			
if !file_exists("savedata3.sav"){option[10,2]= "No saved game"};
